...
contract CryptoDevs is ERC721Enumerable, Ownable {
    ...
    constructor (address initialOwner, address whitelistContract) 
        ERC721("Crypto Devs", "CD") 
        Ownable(initialOwner)
    {
        // Pastikan alamat whitelistContract valid dan kontrak sudah diterapkan ke jaringan yang Anda gunakan
